  ...
  <div class="my-profile-wrapper">
    <el-dialog title="编辑个人资料" :visible.sync="showEditMyProfile" width="30%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="editMyProfile">确 定</el-button>
      </span>
    </el-dialog>
...
export default {
  ...
  mounted() {
      this.form.nick = localStorage.getItem('storeName') // 店铺名字
      // let avatar = JSON.parse(localStorage.getItem('logo')) // 店铺logo
      // this.form.avatar = avatar[0]
    this.form.avatar = localStorage.getItem('logo')
    if (this.form.nick !== '' || this.form.nick !== null || this.form.avatar !== '' || this.form.avatar !== null) {
      setTimeout(() => {
        this.editMyProfile()
      },1000)
    }
