...
<!--        <el-button @click="sendCustomMessage">确 定</el-button>-->
<!--      </span>-->
<!--    </el-dialog>-->
    <el-dialog title="对我们的服务水平的评价" :visible.sync="surveyDialogVisible" width="30%">
      <el-form label-width="100px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="sendSurvey">确 定</el-button>
      </span>
    </el-dialog>
    <el-popover
      trigger="manual"
